    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-200 overflow-hidden">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-700 text-lg max-w-2xl mx-auto">
          Get ready to achieve your academic goals with expert-led mock tests, personalized guidance, 
          and hands-on practice sessions designed for real entry exam success.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-14 items-center w-full max-w-6xl">
        ...
        >
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <select className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none transition-shadow hover:shadow-sm">
                <option>Select a course</option>
                <option>Medical Entry Test</option>
                <option>Engineering Entry Test</option>
                <option>Commerce Preparation</option>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-3 rounded-full font-semibold text-lg shadow-md hover:shadow-lg flex items-center justify-center gap-2 transition-all duration-300"
            >
        ...
        >
          ...
          >
            <BookOpen className="text-indigo-600" /> <span className="text-sm font-medium">1000+ Practice Tests</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
