...
//         const cleaned = hasCorrect
//             ? updated
//             : updated.map((opt, i) => ({ ...opt, isCorrect: i === 0 }));
//         setOptions(cleaned);
//     };
...
//                     {/* Title */}
//                     <div>
//                         <label className="block mb-2 text-lg font-semibold text-indigo-900">
//                             Question Title:
//                         </label>
//                         <input
//                             type="text"
...
//     );
// }
// src/app/admin/paper/[paperId]/add-question/page.tsx
'use client';
