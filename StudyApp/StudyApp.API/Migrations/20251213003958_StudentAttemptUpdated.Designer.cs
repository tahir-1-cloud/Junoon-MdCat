...
namespace StudyApp.API.Migrations
{
    ...
    [Migration("20251213003958_StudentAttemptUpdated")]
    partial class StudentAttemptUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyApp.API.Domain.Entities.StudentLecture", b =>
                {
                    b.HasOne("StudyApp.API.Domain.Entities.Lecturedetails", "Lecturedetails")
                        .WithMany("StudentLectures")
                        .HasForeignKey("LecturedetailId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("StudyApp.API.Domain.Entities.ApplicationUser", "Students")
                        .WithMany("StudentLectures")
            ...
            modelBuilder.Entity("StudyApp.API.Models.StudentAttempt", b =>
                {
                    ...
                    b.HasOne("StudyApp.API.Domain.Entities.ApplicationUser", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
